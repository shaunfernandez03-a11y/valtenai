import SEOAnimation from "@/components/graphics/SEOAnimation";
...
const features = [
  ...
  { icon: "🔑", title: "Local Keyword Targeting", desc: "We research exactly what your customers are searching and build your content strategy around those terms." },
  { icon: "⭐", title: "Review Generation", desc: "Automated systems to generate a steady flow of 5-star reviews — the single biggest ranking factor in local search." },
  { icon: "📝", title: "On-Page SEO", desc: "Meta titles, descriptions, headings, schema markup and internal linking — every technical element optimised." },
  { icon: "🏛️", title: "Citation Building", desc: "Your business listed consistently across 50+ directories and data aggregators — building the trust signals Google rewards." },
  { icon: "📈", title: "Monthly Reporting", desc: "Clear reports showing your ranking positions, traffic, call volume and the direct revenue impact of our work." },
];

const faqs = [
  { q: "How long does SEO take to work?", a: "Local SEO typically shows meaningful results within 60–90 days. Google Business Profile optimisation can show results within weeks." },
  { q: "Do I need to write content?", a: "No — we handle all content creation as part of the service. You approve everything before it goes live." },
  { q: "What if I'm in a competitive area?", a: "We audit your competitors as part of onboarding and build a strategy specifically designed to outrank them." },
  { q: "Is this a one-off or ongoing?", a: "SEO is an ongoing process — Google rewards consistency. We offer monthly retainers that compound in value over time." },
];
    ...
    <div style={{ background: "#0a0f1e", position: "relative" }}>
      ...
      <section style={{ padding: "10rem 1.5rem 6rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "760px", margin: "0 auto", position: "relative" }}>
          <p className="reveal" style={{ fontFamily: "\'Space Mono\', monospace", fontSize: "0.7rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a84c", marginBottom: "1.25rem" }}>Services — SEO & Google Visibility</p>
          <h1 className="reveal" style={{ fontFamily: "\'Cormorant Garamond\', serif", fontSize: "clamp(2.8rem, 6vw, 5rem)", fontWeight: 700, color: "#f8f8f8", lineHeight: 1.1, marginBottom: "1.5rem", transitionDelay: "0.1s" }}>
            Get Found First.<br /><span style={{ color: "#c9a84c" }}>Every Single Time.</span>
          </h1>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "1.1rem", color: "rgba(248,248,248,0.62)", lineHeight: 1.8, maxWidth: "560px", margin: "0 auto 2.5rem" }}>
            93% of local searches end with a visit or call to one of the top 3 results. If you're not there, your competitors are taking your customers. We put you at the top and keep you there.
          </p>
      ...
      <section style={{ borderTop: "1px solid rgba(201,168,76,0.12)", borderBottom: "1px solid rgba(201,168,76,0.12)", padding: "2.5rem 1.5rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2rem", textAlign: "center" }}>
          {[["93%", "of local searches click top 3"], ["46%", "of all Google searches are local"], ["60–90", "days to first results"], ["50+", "directories we build citations on"]].map(([stat, label]) => (
            <div key={stat}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            ...
            <h2 className="reveal" style={{ fontFamily: "\'Cormorant Garamond\', serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "#f8f8f8", transitionDelay: "0.1s" }}>
              Everything Needed to <span style={{ color: "#c9a84c" }}>Own Your Local Market</span>
            </h2>
          </div>
      ...
      <section style={{ padding: "6rem 1.5rem", background: "rgba(201,168,76,0.03)", borderTop: "1px solid rgba(201,168,76,0.08)" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="reveal" style={{ fontFamily: "\'Cormorant Garamond\', serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "#f8f8f8", marginBottom: "3rem", transitionDelay: "0.1s" }}>A Strategy That Compounds</h2>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {[["01","Audit & Research","We audit your current rankings, Google Business Profile, reviews and competitor landscape to find every opportunity."],["02","Optimise & Build","We optimise your profile and website, build citations and launch a review generation campaign — all in the first 30 days."],["03","Grow & Report","Monthly optimisation, content and reporting. Your rankings improve every month and the results compound over time."]].map(([num, title, desc], i) => (
      ...
      <section style={{ padding: "6rem 1.5rem", textAlign: "center", borderTop: "1px solid rgba(201,168,76,0.12)", background: "linear-gradient(135deg, rgba(201,168,76,0.05) 0%, transparent 100%)" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <h2 className="reveal" style={{ fontFamily: "\'Cormorant Garamond\', serif", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 700, color: "#f8f8f8", marginBottom: "1rem" }}>
            Your Competitors Are <span style={{ color: "#c9a84c" }}>Taking Your Customers</span>
          </h2>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "1rem", color: "rgba(248,248,248,0.55)", marginBottom: "2.5rem", lineHeight: 1.7 }}>Book a free audit and we'll show you exactly where you're losing visibility — and how fast we can fix it.</p>
