...
const features = [
  {
    ...
    desc: "Never send a customer to voicemail again. Your AI answers every call instantly — at 2am on a Sunday just as professionally as 10am on a Monday.",
  },
  {
    icon: "📅",
    title: "Automated Booking",
    desc: "Callers can book tables, appointments or services directly through the call — no staff required, no double bookings, synced to your calendar in real time.",
  },
  {
    icon: "🎯",
    title: "Lead Qualification",
    desc: "The AI asks the right questions, qualifies enquiries and routes hot leads to you directly — so you only spend time on calls that matter.",
  },
  {
    icon: "🗣️",
    title: "Your Brand's Voice",
    desc: "Custom scripted to sound like your business. Your tone, your FAQs, your offers — not a generic bot.",
  },
  {
    icon: "📊",
    title: "Call Analytics",
    desc: "See every call, outcome and missed opportunity in a dashboard. Know exactly what customers are asking for.",
  },
  {
    icon: "🔗",
    title: "CRM Integration",
    desc: "Every caller's details and intent automatically logged into your CRM. No manual data entry, no leads lost.",
  },
];
...
const faqs = [
  {
    ...
    a: "No — modern AI voice assistants are indistinguishable from human staff in most cases. We fine-tune the voice and script specifically for your business.",
  },
  {
    q: "What happens if a caller asks something it can't handle?",
    a: "It smoothly transfers the call to you or a staff member, or takes a message and notifies you instantly.",
  },
  {
    q: "How long does setup take?",
    a: "Most businesses are live within 5–7 business days from the free audit.",
  },
  {
    q: "Does it work with my existing phone number?",
    a: "Yes — we forward calls from your existing number, no need to change anything customer-facing.",
  },
];
    ...
    <div style={{ background: "#0a0f1e", minHeight: "100vh", position: "relative" }}>
      ...
      <section style={{ padding: "10rem 1.5rem 6rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "760px", margin: "0 auto", position: "relative" }}>
          <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.7rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a84c", marginBottom: "1.25rem" }}>
      ...
      <section style={{ borderTop: "1px solid rgba(201,168,76,0.12)", borderBottom: "1px solid rgba(201,168,76,0.12)", padding: "2.5rem 1.5rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2rem", textAlign: "center" }}>
          {[["67%", "of callers hang up if sent to voicemail"], ["3x", "more bookings vs missed call"], ["< 1s", "average answer time"], ["24/7", "always on, never sick"]].map(([stat, label]) => (
            <div key={stat}>
      ...
      <section style={{ padding: "6rem 1.5rem", textAlign: "center", borderTop: "1px solid rgba(201,168,76,0.12)", background: "linear-gradient(135deg, rgba(201,168,76,0.05) 0%, transparent 100%)" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "1rem", color: "rgba(248,248,248,0.55)", marginBottom: "2.5rem", lineHeight: 1.7 }}>
            Book a free 15-minute audit and we'll show you exactly how many calls and bookings your business is currently missing.
          </p>
          <a href={AUDIT_URL} target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(AUDIT_URL, "_blank", "noopener,noreferrer"); }} className="btn-gold" style={{ fontSize: "0.8rem", padding: "1rem 2.4rem" }}>
